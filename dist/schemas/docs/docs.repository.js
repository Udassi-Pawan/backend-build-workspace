...
let DocsRepository = exports.DocsRepository = class DocsRepository {
    constructor(DocModel) {
        this.DocModel = DocModel;
    }
    async findOne(DocFilterQuery) {
    ...
    async findOneAndUpdate(DocFilterQuery, Doc) {
        return this.DocModel.findOneAndUpdate(DocFilterQuery, Doc);
    }
};
exports.DocsRepository = DocsRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('Doc')),
